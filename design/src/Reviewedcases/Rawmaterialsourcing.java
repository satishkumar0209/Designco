...
public class Rawmaterialsourcing 
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Reviewed Rawmaterialso-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Rawmaterialso");
