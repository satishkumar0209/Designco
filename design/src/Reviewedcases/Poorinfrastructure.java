...
public class Poorinfrastructure 
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Reviewed poorinfrastructure-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("poor");
