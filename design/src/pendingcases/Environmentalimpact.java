...
public class Environmentalimpact
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Pending Environmental impact-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Environmentalimpact");
