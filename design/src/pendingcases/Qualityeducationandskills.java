...
public class Qualityeducationandskills
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Pending quality education-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Quality");
