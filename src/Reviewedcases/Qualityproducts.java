...
public class Qualityproducts 
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Reviewed Qualityproducts-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Qualitypro");
