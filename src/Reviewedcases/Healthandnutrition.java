...
public class Healthandnutrition 
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Reviewed healtha and nutrition-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Health");
