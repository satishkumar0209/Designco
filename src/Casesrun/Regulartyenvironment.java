...
public class Regulartyenvironment 
{
ATUTestRecorder recorder;
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Regularityenvironment-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Regularty");
