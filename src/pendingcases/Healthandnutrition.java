...
public class Healthandnutrition
{
	...
	public void user() throws InterruptedException, ATUTestRecorderException
	{
		...
		recorder = new ATUTestRecorder("/home/aj/Documents/Selenium recording videos","Pendind Health and nutrition-",false);
		recorder.start();
		...
		Cases.Searchinputfield(driver).sendKeys("Healthand");
